...
1. Be between a 5-7 minute read as calculated by medium.com. See this [example](https://eidolon.pub/x-fiddled-while-y-burned-80abf13e7c08){target="_blank"}.
1. Should use text formating, images, links.
1. Close with a reflection on not just the *outcome* of your research, but on the *process* your research. What went well, what didn't, etc.
