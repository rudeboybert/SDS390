...
Given an assumed model $y = f(\vec{x}) + \epsilon$, you want an fitted model $\widehat{y} = f(\vec{x})$. To do this, you need to do *parameter estimation*. [PDF of chalk talk](static/chalk_talks/Lec05.pdf){target="_blank"}.
