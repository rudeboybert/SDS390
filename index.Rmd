...
1. Create a new Google Doc from your Smith Google Drive, title it "BFD - <YOUR NAME>", share it with me so that I can edit it, and then send me a link to it in a private Slack DM (not the group channel). 
