...
1. ForestGEO Network: Talk about paper
1. Breakout room: data collection
1. Demo of what you'll be doing for MP2.
...
One way to measure a tree's dbh is using dendrobands. 
...
### 2. Time series and basic forecasting

Coming by Monday 9/7 7pm!
...
These will be finalized just before class meeting time starts at 9:45am.

1. Announcements
    1. Office hours:
1. Check in on MP1
1. Discussion on dendrobands: Video 1
1. Discussion on time series and basic forecasting: Video 2 & readings
