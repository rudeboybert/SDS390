...
dendrometer bands by McMahon and Parker (2015)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4314258/){target="_blank"}.
    1. Copy the code below as you did for the code in Lec03
1. Announcements:
    1. Please vote on three polls I posted in #announcements on Slack.
    1. Start next week I'll have a decidated zoom room for this class. I will share link on Slack before next lecture.
1. Breakout rooms:
...
# Load (simulated) dendroband data
dendroband_data <- 
  read_csv("https://rudeboybert.github.io/SDS390/static/data/observed_dbh_vs_doy.csv")
