...
1. Test out voice recording:
    ...
    1. Send it to me via email: akim04@smith.edu
1. Create a new Google Doc from your Smith Google Drive, title it "BFD - <YOUR NAME>", share it with me at akim04@smith.edu, and then send me a link to it in a private Slack DM (not the group channel). 
