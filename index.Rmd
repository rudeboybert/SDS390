...
<iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQw8rrRUpbMRdy01pwUDw4C65XK1ekgQZWUeWN66L5KrAwtXuWMuo1EEk-2qULxsYPforSIAIsEI1dY/pubhtml?gid=1373353942&amp;single=true&amp;widget=true&amp;headers=false" width="100%" height="630"></iframe>
...
# Lec 27: Tue 12/8 {#Lec27}

## Class meeting time

<!--
closing the loop
- I was a little bit worried at the beginning of the semester. New discipline, no established curriculum
- Mentor map: Peter de Villiers
- Projects, research group. Take advantage of small number of students
- Turned into mini-capstone

Shout outs
- Lauren L
- Graduating 2021J: Candy and Starry

Chat with seniors: Sophie, Emma S, Starry, Candy, Lauren, Olivia
-->

1. Announcements:
    1. Be sure to *publish* and DM me a link to your medium.com article by 11pm eastern tonight.
    1. Resubmissions to Mini-Projects due at 11pm tonight.
1. "Closing the loop" - An expression I learned from NCFDD:
    1. If you ask someone for something, be sure to follow up afterwards.
    1. Taking stock
1. Shout outs
1. Fill out
    1. [Exit Survey Google Form](https://docs.google.com/forms/d/e/1FAIpQLSf9WPTp8Da4QQjdYi8jRrskpaBfDj8fKgJozpm6fV6QyxUPgQ/viewform){target="_blank"}
    1. Please, please, please also fill out teaching evaluations from Smith College!
1. [Link](https://smith.zoom.us/rec/share/c7M60zE6VPJ8R3_EWlE32NSYhkCyGwzriCu2aSt9Og__M6Psu1ft9DGT_NpGH9Fv.bD6ADSrN7w7rn6rS?startTime=1607438712000){target="_blank"} to video recording.
...
# Lec 26: Thu 12/3 {#Lec26}

## Class meeting time

1. Announcements:
    1. If anyone is interested in SCBI data cleaning work, DM me.
    1. See note added to [blogpost instructions](#blogpost)
    1. I'll go over all MP's one last time and give feedback to blogposts on Monday morning
1. Presentation by Group 3 - Wildfire biomass estimation
1. Presentation by Group 4 - Competitor/neighbor modeling
1. [Link](https://smith.zoom.us/rec/share/8O1vLZ9FymzN1O3aE6Ce0rxVQdbZ7ioJGh85Oqo2iduH9DWtQEFInOS3koeorXqo.1mDgv09Wt-Q_jLEh){target="_blank"} to video recording.
...
# Lec 25: Tue 12/1 {#Lec25}

## Class meeting time

1. Presentation by Group 1 - Time Series Forecasting
1. [Link](https://smith.zoom.us/rec/share/YNIwt_rP4IVdtf3jba-RqzQEzap3_VshM6STcLlbXUjBWmp9JATh_Zgprn-L2M_q.cqRYvOlJHYsuIUQS){target="_blank"} to video recording.


## Blogpost instructions {#blogpost}

### a) By the end of today

1. Blogpost:
    1. Create an account on medium.com
    1. Fill out your profile
    1. Click your profile pic -> Write a story
    1. Copy and paste the contents of your 🤮1️⃣📝
    1. Click ... -> Share draft link -> Copy and paste link in Slack DM to me
1. [Jacobson Writing Center](https://www.smith.edu/academics/jacobson-center/student-services#tutorial){target="_blank"}:
    1. Click on schedule a writing appointment
    1. Create an account
    1. Book an appointment to see any writing counselor (other than Lauren).
    1. Forward me confirmation email

### b) Content

1. State what your group's research goal was.  
1. Target an audience that has seen linear regression before, but is not necessarily a stats/data science major.
1. Be between a 5-7 minute read as calculated by medium.com. See this [example](https://eidolon.pub/x-fiddled-while-y-burned-80abf13e7c08){target="_blank"}. **Added after lecture**: the 5-7 minute guide is a rough principle. If you feel you need to exceed, please do. Note that if this limit is too restrictive, please let me know and we can discuss revisiting. 
1. Should use text formating, images, links, quotes, etc.
1. **Edited after lecture**: Focus not just on the *outcome* of your research, but on a reflection on the *process* your research. By process I mean you are telling a *holistic story* on any of the aspects of the research half of this course: picking the project, what went well, what didn't, what problems you encountered, the group work format, the presentations, the weekly meetings, etc.
1. **Added Thu 12/3**: Be sure to cite all sources, either via hyperlinks or a reference section at the end.
...
1. In-class activity: Bad first draft!
1. [Link](https://smith.zoom.us/rec/share/RCAiqbCOvZll34jjbf_TLLhJyWRYl3WZG8DIZB0li2kb1O43zopr9FyNwfzZIUUP.Kb1Zrv6wglHuXtHG?startTime=1606229052000){target="_blank"} to video recording.
