...
1. While there is no explicit lecture today, class is **not cancelled.** Please:
    ...
    1. Take a selfie proving you met up to work. This counts to your participation/engagement grade
    1. Create a Slack DM that has all group members + me and send me the photo
1. PS4 presentations on Thursday. Please re-read instructions on [Problem Sets](PS.html) page. 
...
1. FPP 9.3 Autoregressive model: Specific cases of AR(1) model
    ...
    1. Random walk with drift [example](https://fisher.stats.uwo.ca/faculty/aim/2018/3859A/RNotebooks/05_TimeSeriesVis/05C_RandomWalk_Nov21.html)
1. FPP 9.4 Moving Average modeling (recall: this is not moving average smoothing)
1. FPP 9.5 Non-seasonal ARIMA models
1. FPP 9.7 Modeling procedure
...
1. Final project added instructions


## Lecture

1. FPP 9.1 Stationarity and differencing
1. FPP 9.2 Backshift notation    
1. FPP 9.3 Autoregressive model
    1. Random walk [example](https://stats.stackexchange.com/questions/159650/why-does-the-variance-of-the-random-walk-increase/159653#159653)
    1. Random walk with drift [example](https://fisher.stats.uwo.ca/faculty/aim/2018/3859A/RNotebooks/05_TimeSeriesVis/05C_RandomWalk_Nov21.html)
    1. Recall [PS2](https://github.com/rudeboybert/SDS390/blob/master/PS/PS02_albert.ipynb)
...
1. Final project extra notes
    1. Fit between 2-4 models, one of which needs to be an ARIMA model
    1. Do a residual analysis of the model selected for forecasting into the future using all the available data
...
1. Recorded lecture posted in Screencasts tab of webpage (top right). Please post questions in Slack under `#questions` including the point in time in video your question corresponds to. Topics:
    ...
    1. FPP 8.3 Exponential smoothing with seasonality
1. PS4 files posted on Slack, please read instructions on Problem Sets page 
