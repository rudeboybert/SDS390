...
- Mountain Day recap
- Finish chalk talk on FPP Chapter 2. See code below
- DataCamp
    1. Go to Roster Google Sheet (top right of page) and fill in both DC columns
    1. Poll class on sli.do about DC
    1. DC exercise numbering system: Ex 2.1.3 = Chapter 2, Video 1, Exercise 3.
    1. Prof. Kim gets vulnerable and does MTSD course Ex 2.1.3
    1. Screencast location
    1. Continuing [Time Series with Python](https://app.datacamp.com/learn/skill-tracks/time-series-with-python) skill track:
        ...
        1. Next course in track ["Time Series Analysis in Python"](https://app.datacamp.com/learn/courses/time-series-analysis-in-python) due Tue 10/3. If you have any exercise you'd like me to do in class, let me know. 
