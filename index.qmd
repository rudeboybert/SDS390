...
- DataCamp
    ...
    1. Original ["Manipulating Time Series Data in Python"]() course due next Tue 9/26 before class
    1. Next course in [Time Series with Python](https://app.datacamp.com/learn/skill-tracks/time-series-with-python) skill track, ["Time Series Analysis in Python"]()
