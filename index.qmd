...
1. PS1 submission format posted
...
# 2.a) Fig 3.13 top plot: Original TS data
ggplot(full_decomposition, aes(x=Month, y = Employed)) +
  geom_line() +
  labs(title = "Original data")

# 2.b) Fig 3.13 2nd plot: trend-cycle via MA average method
...
# 2.d) Fig 3.13 3rd plot: seasonality (values repeat every 12 months)
ggplot(full_decomposition, aes(x=Month, y = seasonal)) +
  geom_line() +
  labs(title = "Seasonality")

# 2.e) Fig 3.13 4th plot: Compute remainders
...
# 3.a) Get data frame with full breakdown of decomposition
...
# 3.d) Step 4: Compute remainder R_hat_t = 5.6491610
# y_t - T_hat_t - S_hat_t
