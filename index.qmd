...
1. Discuss slido [responses](https://admin.sli.do/event/3x3vyqpgVxaVxm6XTJLxxF/analytics)
1.


## Lecture

1. Theory covered in "Time Series Analysis in Python" DataCamp course
1. Context and background about PS02 data
...
Prof. Kim's thoughts about ChatGPT. It is a very powerful tool, but you need to be:

1. Knowledgeable enough to understand the code
1. Experienced enough in your domain and programming to know what to prompt
1. Disciplined enough to sanity check your results
...
1. I will make groups at random using code above. I will join a group if there is an odd person left out.
1. Work together for 20 minutes to come up with single `.ipynb`
1. I will pick two teams at random to present to the class
1. I will present my work to the class. click [here](https://github.com/rudeboybert/SDS390/blob/master/PS/PS01_albert.ipynb)
1. Answer the sli.do poll [here](https://app.sli.do/event/3x3vyqpgVxaVxm6XTJLxxF)
