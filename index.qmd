...
Next problem set: 
- have students explicitly compute forecasting with decompvalues from scratch, giving them the actual solution i.e. the values in Fig 5.18
...
1. Fill out PS02 peer eval Google Form and slido poll
...
1. PS02 mini-presentations today. Info in [Problem Sets](PS.html)
...
1. Update PS02 in-class presentation format in [Problem Sets](PS.html)
1. PS02 mini-presentations this coming Tuesday
